  ...
  return (
    <div className="flex flex-col gap-2 relative h-screen w-screen bg-mapbox-black-900" id = "rootDiv">
      ...
      <div className="w-full h-4/6" id = "mapboxInputWrapper">
        <MapBoxInput setIsSubmissionEnabled={setIsSubmissionEnabled} zoomLevelThreshold={zoomLevelThreshold}/>
      </div>
      <div className = "self-center w-4/5 h-14">
        <Button enabled = {isSubmissionEnabled}>
          {isSubmissionEnabled ? "Next" : "Zoom in to enable submission"}
        </Button>
      </div>
    </div>
  )
